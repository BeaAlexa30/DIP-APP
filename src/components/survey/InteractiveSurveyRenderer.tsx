                                ...
                                {isOther ? (
                                  ...
                                  >
                                    ...
                                    <input
                                      ...
                                      className={`flex-1 text-xs sm:text-sm focus:outline-none bg-transparent ml-2 ${isSelected ? 'text-white placeholder:text-white/60' : 'text-gray-700 placeholder:text-gray-400'}`}
                                    />
                                  </Button>
                                ) : (
                                  <Button
