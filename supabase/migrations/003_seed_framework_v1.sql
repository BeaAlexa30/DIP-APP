...
-- Category 5: Loyalty & Advocacy Potential (Q19-Q21)
  ...
  ('00000000-0000-0000-0000-000000000020', 'a1b2c3d4-0001-0001-0001-000000000001', 'ca000001-0001-0001-0001-000000000005', 'scale',
   'On a scale of 0–10, how likely are you to recommend this to a friend or colleague? (NPS)', TRUE, 2),
...
-- Q20: NPS (0–10 scale)
INSERT INTO framework_options (question_id, label, value_key, order_index) VALUES
  ('00000000-0000-0000-0000-000000000020', '0',   'q20_0',  1),
  ('00000000-0000-0000-0000-000000000020', '1',   'q20_1',  2),
  ('00000000-0000-0000-0000-000000000020', '2',   'q20_2',  3),
  ('00000000-0000-0000-0000-000000000020', '3',   'q20_3',  4),
  ('00000000-0000-0000-0000-000000000020', '4',   'q20_4',  5),
  ('00000000-0000-0000-0000-000000000020', '5',   'q20_5',  6),
  ('00000000-0000-0000-0000-000000000020', '6',   'q20_6',  7),
  ('00000000-0000-0000-0000-000000000020', '7',   'q20_7',  8),
  ('00000000-0000-0000-0000-000000000020', '8',   'q20_8',  9),
  ('00000000-0000-0000-0000-000000000020', '9',   'q20_9',  10),
  ('00000000-0000-0000-0000-000000000020', '10',  'q20_10', 11)
ON CONFLICT DO NOTHING;

INSERT INTO framework_scoring_rules (question_id, option_value_key, score_delta, risk_flag, friction_flag, driver_tag) VALUES
  ('00000000-0000-0000-0000-000000000020', 'q20_0',   0, TRUE,  FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_1',   1, TRUE,  FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_2',   2, TRUE,  FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_3',   3, TRUE,  FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_4',   4, TRUE,  FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_5',   5, FALSE, FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_6',   6, FALSE, FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_7',   7, FALSE, FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_8',   8, FALSE, FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_9',   9, FALSE, FALSE, 'nps'),
  ('00000000-0000-0000-0000-000000000020', 'q20_10', 10, FALSE, FALSE, 'nps')
ON CONFLICT DO NOTHING;
